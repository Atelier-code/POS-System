        ...
        <div class=" p-2 bg-white">
            <div class="w-full flex flex-col xl:flex-row">
                ...
                <div class="xl:w-1/3 w-full p-2">
                    <img src="{{ asset(auth()->user()->image) }}" alt="User Image" class="object-cover mx-auto">
                </div>
                ...
                <div class="xl:mt-10 xl:w-2/3 xl:ml-[5.5rem]">
                    ...
                    <div class="mt-10 mb-4">
                        ...
                        <form action="{{ route('cashier.resetPassword') }}" method="post">
                            @csrf
                            <!-- Old Password -->
                            <div class="w-80 mb-2">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    Swal.fire({
                        ...
                        timer: 3000, // Closes the alert after 3 seconds (3000 ms)
                        timerProgressBar: true, // Displays a progress bar
                        showConfirmButton: true // Keeps the "OK" button visible
                    });
                });
            </script>
        @endif
