            ...
            <header class="bg-white shadow sticky top-0 h-16 z-50 px-[5rem] flex items-center justify-between">
                ...
                <div class="flex items-center w-1/3 gap-12">
                    <a href="/cashier/dashboard" class="text-2xl font-bold text-dark">
                        MIGHTY JESU<span class="text-orange-500"> POS</span>
                    </a>
                ...
                <div class="absolute top-[5rem] right-[5rem] w-72 p-4 bg-white rounded-md shadow-lg transform transition-all duration-300 ease-in-out"
                    ...
                    <a href="{{route('logout')}}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <path fill-rule="evenodd"
                                d="M6.364 5.636a.5.5 0 0 1 0 .707L4.707 8l1.657 1.657a.5.5 0 0 1-.707.707L3.5 8.707a.5.5 0 0 1 0-.707l2.157-2.157a.5.5 0 0 1 .707 0zM9.5 4a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 15.5 5v6a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1-.5-.5V11a.5.5 0 0 1 .5-.5h3.5V5.5H9.5A.5.5 0 0 1 9 5V4.5a.5.5 0 0 1 .5-.5z" />
                        </svg>
                        Logout
                    </a>
                </div>
